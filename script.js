...
function openBlogModal(blogId) {
    ...
    // Load the specific blog content
    loadBlogContent(blogId, modalBody);
...
function loadBlogContent(blogId, container) {
...
function getBlogContent(blogId) {
    const blogContents = {
        'email-marketing-guide': `
            <h1>Email Advertising for Bloggers: Complete Guide to Building and Monetizing Your List</h1>
            
            <h2>1. What is Email Advertising for Bloggers?</h2>
            ...
            <h2>2. Email Marketing Fundamentals for Bloggers</h2>
            
            <h3>How to Choose an Email Service Provider</h3>
            ...
            <h3>Setting Up Your List and Signup Forms</h3>
            ...
            <h2>3. Growing Your Email List</h2>
            ...
            <h2>4. Types of Email Campaigns for Bloggers</h2>
            ...
            <h3>Automated Welcome Series</h3>
            ...
            <h3>Educational or Value-Added Series</h3>
            ...
            <h3>Personalization & Dynamic Content</h3>
            ...
            <p>GDPR, CAN-SPAM, and other regulations: only send to opt-ins, always provide an unsubscribe link, don't share personal data without consent.</p>
            
            <h2>6. Content Creation Tips</h2>
            
            <h3>Great Subject Lines</h3>
            ...
            <h2>Expanded Case Studies: Blogs That Scaled With Smart Email Campaigns</h2>
            
            <div class="case-study">
                <h3>Case Study 1: Rapid List Growth with Content Upgrades (Personal Finance Blog)</h3>
                
                <p><strong>Scenario:</strong> Created downloadable spreadsheets for budgeting as content upgrades on high-traffic posts.</p>
                
                <p><strong>Execution:</strong> Automated welcome sequence on signup, introducing more advanced resources and exclusive webinars.</p>
                
                <p><strong>Results:</strong> 6,000+ new subscribers in 8 months. Webinar promotions and affiliate offers through emails generated $2,000–$6,000 per month in added income.</p>
            </div>
            
            <div class="case-study">
                <h3>Case Study 2: Laser-Focused Segmentation (Travel Blog)</h3>
                
                <p><strong>Scenario:</strong> Used interest survey on signup—"Budget Trips," "Luxury Escapes," or "Family Travel."</p>
                
                <p><strong>Execution:</strong> Tailored weekly emails: budget travelers received hostel deals, luxury travelers received resort reviews, families got kid-friendly itineraries.</p>
                
                <p><strong>Results:</strong> Open rates >44%, click rates of 12–18%, sponsorships and exclusive partnerships from travel brands due to engaged audience.</p>
            </div>
            
            <div class="case-study">
                <h3>Case Study 3: Product Launch Success via Email Automation (Fitness Blog)</h3>
                
                <p><strong>Scenario:</strong> Offered a "7-Day Home Workout" challenge by email.</p>
                
                <p><strong>Execution:</strong> Automated educational emails during challenge, then led to offer for full workout program.</p>
                
                <p><strong>Results:</strong> Used urgency ("offer ends soon!") for launch push. 700+ course sales ($10,000+) in 2 weeks, with 70% of sales from the email list alone.</p>
            </div>
            
            <div class="case-study">
                <h3>Case Study 4: RSS-to-Email Grows Repeat Traffic (Tech Review Blog)</h3>
                
                <p><strong>Scenario:</strong> Set up RSS-to-email so every new review was sent to subscribers.</p>
                
                <p><strong>Execution:</strong> Added exclusive deals just for email readers (discounts, early access).</p>
                
                <p><strong>Results:</strong> Over 45% of weekly blog traffic driven by email. Community engagement led to reader-driven requests for product reviews, improving site authority and SEO.</p>
            </div>
            
            <div class="case-study">
                <h3>Case Study 5: Community Building and Reader Generated Content (Parenting Blog)</h3>
                
                <p><strong>Scenario:</strong> Weekly "Letters from Our Readers"—featuring tips, stories, or questions from subscribers.</p>
                
                <p><strong>Execution:</strong> Invited feedback and submissions, highlighted best comments in each edition.</p>
                
                <p><strong>Results:</strong> Response rate skyrocketed. Blog owner invited to parent conferences, offered a book deal due to loyal and interactive community.</p>
            </div>
            
            <h2>FAQs for Beginners</h2>
            
            <h3>1. How often should I email my list?</h3>
            <p>Start with once per week, then adjust based on subscriber feedback and engagement.</p>
            
            <h3>2. How do I avoid spam filters?</h3>
            <p>Send to engaged, opted-in subscribers, avoid spammy words, maintain list hygiene, and use reputable email services.</p>
            
            <h3>3. What should I write in my first email?</h3>
            <p>Introduce yourself, explain what readers will get, and link to your best or most popular blog content.</p>
            
            <h3>4. Is it worth it for a small blog?</h3>
    ...
    return blogContents[blogId] || '<p>Blog content not found.</p>';
}
